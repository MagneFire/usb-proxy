...
// Non-exiting variants for the functions usb-proxy answers locally
// (console-acm.cpp and the gadgets that carry it), which must fail open:
// they return the ioctl result and -errno on error instead of exit()ing like
// the wrappers above.
